...
\section{Methodology}
We employ an experimental ladder design to isolate the impact of native-language code on multilingual LLM performance. The base model is \texttt{CohereLabs/tiny-aya-base} (3.35B parameters), trained using QLoRA 4-bit quantization on Kaggle T4 GPUs.
...
The datasets were uploaded to Hugging Face \cite{legesher_language_decoded} for accessibility during continued pretraining.
...
\addplot coordinates {(Baseline,35.8) (Cond1,36.1) (Cond2-zh,42.3) (Cond2-es,34.2) (Cond2-ur,34.6) (Cond3-zh,35.8)};
\addplot coordinates {(Baseline,49.1) (Cond1,47.3) (Cond2-zh,43.1) (Cond2-es,44.5) (Cond2-ur,48.8) (Cond3-zh,41.6)};
\addplot coordinates {(Baseline,38.1) (Cond1,36.8) (Cond2-zh,36.2) (Cond2-es,33.3) (Cond2-ur,37.7) (Cond3-zh,34.0)};
\legend{Chinese,Spanish,Urdu}
\end{axis}
\end{tikzpicture}
\caption{XNLI Native Prompt Accuracy by Condition}
\label{fig:xnli_results}
\end{figure}
